...
* {
  ...
  --cor-27:v-bind('pButtonSecondaryHoverBackgroundColor');
  --cor-29:v-bind('pButtonSecondaryActiveAndFocusBackgroundColor');
  --cor-8 :v-bind('pButtonSucessBackgroundColor');
  --cor-35:v-bind('pButtonSucessHoverBackgroundColor');
  --cor-37:v-bind('pButtonSucessActiveAndFocusBackgroundColor');
  --cor-36:v-bind('pButtonSucessActiveAndFocusBorderColor');
  --cor-38:v-bind('pButtonOutlinedHoverBackgroundcolor');
  --cor-39:v-bind('pButtonOutlinedActiveAndFocusBackgroundColor');
  --cor-24:v-bind('pButtonWarningBackgroundColor');
  --cor-40:v-bind('pButtonWarningHoverBackgroundColor');
  --cor-43:v-bind('pButtonWarningActiveAndFocusBackgroundColor');
  --cor-41:v-bind('pButtonWarningTextColor');
  --cor-42:v-bind('pButtonWarningActiveAndFocusBorderColor');
  --cor-46:v-bind('pButtonHelpBackgroundColor');
  --cor-47:v-bind('pButtonHelpHoverBackgroundColor');
  --cor-49:v-bind('pButtonHelpActiveAndFocusBackgroundColor');
  --cor-48:v-bind('pButtonHelpActiveAndFocusBorderColor');
  --cor-23:v-bind('pButtonDangerBackgroundColor');
  --cor-52:v-bind('pButtonDangerHoverBackgroundColor');
  --cor-54:v-bind('pButtonDangerActiveAndFocusBackgroundColor');
  --cor-53:v-bind('pButtonDangerActiveAndFocusBorderColor');
  --cor-16:v-bind('pDividerColor');
  --cor-15:v-bind('pButtonRaisedBoxshadowUp');
  --cor-14:v-bind('pButtonRaisedBoxshadowDown');
  --cor-18: v-bind('dataTableHeaderColor');
  --cor-2 : v-bind('pInvalidColor');
  --cor-68: #044868;
  --cor-67: #0891cf;
  --cor-22: #191919;
  --cor-71: #224a23;
  ...
  --cor-72: #FFECB3;
  --cor-57: #fff;
  --cor-13: rgba(0, 0, 0, 0.2);
  --cor-58: rgba(0, 0, 0, 0.4);
  --cor-79: rgba(0, 0, 0, 0.5);
  --cor-82: rgba(0, 0, 0, 0.7);
  --cor-83: rgba(0, 0, 0, 0.8);
  --cor-81: rgba(0, 0, 0, 0.9);
  --cor-50: rgba(156, 39, 176, 0.04);
  --cor-51: rgba(156, 39, 176, 0.16);
  --cor-33: rgba(2, 136, 209, 0.04);
  --cor-34: rgba(2, 136, 209, 0.16);
  --cor-55: rgba(211, 47, 47, 0.04);
  --cor-56: rgba(211, 47, 47, 0.16);
  --cor-44: rgba(251, 192, 45, 0.04);
  --cor-45: rgba(251, 192, 45, 0.16);
  --cor-64: rgba(255, 255, 255, 0.1);
  --cor-65: rgba(255, 255, 255, 0.2);
  --cor-78: rgba(255, 255, 255, 0.3);
  --cor-80: rgba(255, 255, 255, 0.4);
  --cor-88: rgba(255, 255, 255, 0.6);
  --cor-63: rgba(255, 255, 255, 0);
...
:root {
  ...
  --green-800:#2a602c;
  --green-900:#1e4620;
  --yellow-50:var(--cor-57)cf5;
  --yellow-100:#fef0cd;
  --yellow-200:#fde4a5;
  --yellow-300:#fdd87d;
  --yellow-400:#fccc55;
  --yellow-500:var(--cor-24);
  --yellow-600:#d5a326;
  --yellow-700:#b08620;
  --yellow-800:#8a6a19;
  --yellow-900:#644d12;
  ...
  --purple-300:#c279ce;
  --purple-400:#af50bf;
  --purple-500:var(--cor-46);
  --purple-600:#852196;
  --purple-700:#6d1b7b;
  --purple-800:#561561;
  --purple-900:#3e1046;
  --red-50:var(--cor-57)5f5;
  --red-100:#ffd1ce;
  --red-200:#ffada7;
  --red-300:#ff8980;
  --red-400:#ff6459;
...
.p-autocomplete-panel {
  ...
  border: 0 none;
  border-radius: 3px;
  box-shadow: 0 2px 4px -1px var(--cor-12), 0 4px 5px 0 var(--cor-14), 0 1px 10px 0 var(--cor-15);
}
...
.p-datepicker .p-datepicker-buttonbar {
  padding: 1rem 0;
  border-top: 1px solid var(--cor-16);
}
...
.p-datepicker.p-datepicker-multiple-month .p-datepicker-group {
  border-left: 1px solid var(--cor-16);
...
.p-colorpicker-panel {
  background: var(--cor-21);
  border: 1px solid var(--cor-22);
}
...
.p-inputgroup-addon {
  background: var(--cor-17);
  color: var(--cor-3);
  border-top: 1px solid var(--cor-19);
  border-left: 1px solid var(--cor-19);
  border-bottom: 1px solid var(--cor-19);
  padding: 0.5rem 0.5rem;
  min-width: 2.357rem;
}
.p-inputgroup-addon:last-child {
  border-right: 1px solid var(--cor-19);
}
...
.p-button.p-button-raised {
  box-shadow: 0 3px 1px -2px var(--cor-12), 0 2px 2px 0 var(--cor-14), 0 1px 5px 0 var(--cor-15);
}
...
.p-button.p-button-secondary.p-button-outlined:enabled:hover, .p-buttonset.p-button-secondary > .p-button.p-button-outlined:enabled:hover, .p-splitbutton.p-button-secondary > .p-button.p-button-outlined:enabled:hover {
  background: var(--cor-30);
  color: var(--cor-7);
  border: 1px solid;
}
.p-button.p-button-secondary.p-button-outlined:enabled:active, .p-buttonset.p-button-secondary > .p-button.p-button-outlined:enabled:active, .p-splitbutton.p-button-secondary > .p-button.p-button-outlined:enabled:active {
  background: var(--cor-89);
  color: var(--cor-7);
  border: 1px solid;
}
...
.p-button.p-button-info.p-button-outlined:enabled:hover, .p-buttonset.p-button-info > .p-button.p-button-outlined:enabled:hover, .p-splitbutton.p-button-info > .p-button.p-button-outlined:enabled:hover {
  background: var(--cor-33);
  color: var(--cor-9);
  border: 1px solid;
}
.p-button.p-button-info.p-button-outlined:enabled:active, .p-buttonset.p-button-info > .p-button.p-button-outlined:enabled:active, .p-splitbutton.p-button-info > .p-button.p-button-outlined:enabled:active {
  background: var(--cor-34);
  color: var(--cor-9);
  border: 1px solid;
}
...
.p-button.p-button-warning.p-button-outlined:enabled:hover, .p-buttonset.p-button-warning > .p-button.p-button-outlined:enabled:hover, .p-splitbutton.p-button-warning > .p-button.p-button-outlined:enabled:hover {
  background: var(--cor-44);
  color: var(--cor-24);
  border: 1px solid;
}
.p-button.p-button-warning.p-button-outlined:enabled:active, .p-buttonset.p-button-warning > .p-button.p-button-outlined:enabled:active, .p-splitbutton.p-button-warning > .p-button.p-button-outlined:enabled:active {
  background: var(--cor-45);
  color: var(--cor-24);
  border: 1px solid;
}
...
.p-button.p-button-help.p-button-outlined:enabled:hover, .p-buttonset.p-button-help > .p-button.p-button-outlined:enabled:hover, .p-splitbutton.p-button-help > .p-button.p-button-outlined:enabled:hover {
  background: var(--cor-50);
  color: var(--cor-46);
  border: 1px solid;
}
.p-button.p-button-help.p-button-outlined:enabled:active, .p-buttonset.p-button-help > .p-button.p-button-outlined:enabled:active, .p-splitbutton.p-button-help > .p-button.p-button-outlined:enabled:active {
  background: var(--cor-51);
  color: var(--cor-46);
  border: 1px solid;
}
...
.p-button.p-button-danger.p-button-outlined:enabled:hover, .p-buttonset.p-button-danger > .p-button.p-button-outlined:enabled:hover, .p-splitbutton.p-button-danger > .p-button.p-button-outlined:enabled:hover {
  background: var(--cor-55);
  color: var(--cor-23);
  border: 1px solid;
}
.p-button.p-button-danger.p-button-outlined:enabled:active, .p-buttonset.p-button-danger > .p-button.p-button-outlined:enabled:active, .p-splitbutton.p-button-danger > .p-button.p-button-outlined:enabled:active {
  background: var(--cor-56);
  color: var(--cor-23);
  border: 1px solid;
}
...
.p-datatable .p-sortable-column:focus {
  box-shadow: inset 0 0 0 0.15rem var(--cor-4);
  outline: 0 none;
}
...
.p-datatable .p-datatable-tbody > tr.p-datatable-dragpoint-top > td {
  box-shadow: inset 0 2px 0 0 var(--cor-11);
}
...
.fc.fc-unthemed .fc-view-container .fc-row {
  border-right: 1px solid var(--cor-16);
}
...
.p-accordion .p-accordion-header:not(.p-disabled) .p-accordion-header-link:focus {
  outline: 0 none;
  outline-offset: 0;
  box-shadow: inset 0 0 0 0.2rem var(--cor-4);
}
...
.p-card {
  background: var(--cor-10);
  color: var(--cor-6);
  box-shadow: 0 2px 1px -1px var(--cor-12), 0 1px 1px 0 var(--cor-14), 0 1px 3px 0 var(--cor-15);
  border-radius: 3px;
}
.p-card .p-card-body {
  padding: 1rem;
...
.p-tabview .p-tabview-nav li .p-tabview-nav-link {
  border: solid var(--cor-16);
  border-width: 0 0 2px 0;
  border-color: transparent transparent var(--cor-16) transparent;
  background: var(--cor-10);
  color: var(--cor-3);
  padding: 1rem;
  font-weight: 600;
...
.p-confirm-popup {
  ...
  border: 0 none;
  border-radius: 3px;
  box-shadow: 0px 11px 15px -7px var(--cor-12), 0px 24px 38px 3px var(--cor-14), 0px 9px 46px 8px var(--cor-15);
}
...
.p-confirm-popup:after {
  ...
  border-color: var(--cor-63);
  border-bottom-color: var(--cor-10);
}
...
.p-overlaypanel:before {
  border: solid transparent;
  border-color: var(--cor-63);
  border-bottom-color: var(--cor-87);
}
...
.p-tooltip.p-tooltip-right .p-tooltip-arrow {
  border-right-color: var(--cor-6);
}
.p-tooltip.p-tooltip-left .p-tooltip-arrow {
  border-left-color: var(--cor-6);
}
.p-tooltip.p-tooltip-top .p-tooltip-arrow {
  border-top-color: var(--cor-6);
}
.p-tooltip.p-tooltip-bottom .p-tooltip-arrow {
  border-bottom-color: var(--cor-6);
}
...
.p-dock .p-dock-list-container {
  background: var(--cor-64);
  border: 1px solid var(--cor-65);
  padding: 0.5rem 0.5rem;
...
.p-inline-message.p-inline-message-info {
  background: var(--cor-66);
  border: solid var(--cor-67);
  border-width: 0px;
  color: var(--cor-68);
}
...
.p-inline-message.p-inline-message-success {
  background: var(--cor-69);
  border: solid var(--cor-70);
  border-width: 0px;
  color: var(--cor-71);
}
...
.p-inline-message.p-inline-message-warn {
  background: var(--cor-72);
  border: solid var(--cor-73);
  border-width: 0px;
  color: var(--cor-74);
}
...
.p-inline-message.p-inline-message-error {
  background: var(--cor-75);
  border: solid var(--cor-76);
  border-width: 0px;
  color: var(--cor-77);
}
...
.p-galleria.p-galleria-indicator-onitem .p-galleria-indicators .p-galleria-indicator button {
  background: var(--cor-80);
}
.p-galleria.p-galleria-indicator-onitem .p-galleria-indicators .p-galleria-indicator button:hover {
  background: var(--cor-88);
}
...
.p-scrolltop.p-link {
  background: var(--cor-82);
}
.p-scrolltop.p-link:hover {
  background: var(--cor-83);
}
...
.p-skeleton:after {
  background: linear-gradient(90deg, var(--cor-63), var(--cor-80), var(--cor-63));
}
...
.p-datatable .p-datatable-tbody > tr.p-datatable-dragpoint-top > td {
  box-shadow: inset 0 2px 0 0 var(--cor-5);
}
.p-datatable .p-datatable-tbody > tr.p-datatable-dragpoint-bottom > td {
  box-shadow: inset 0 -2px 0 0 var(--cor-5);
}
